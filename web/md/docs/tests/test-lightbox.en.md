...
![Single test image 800x500](../../static/lightbox/test-1.png)
...
![Second test image 640x800](../../static/lightbox/test-2.png)

![Third test image 1200x675](../../static/lightbox/test-3.png)

![Fourth test image 500x500](../../static/lightbox/test-4.png)

![Fifth test image 900x600](../../static/lightbox/test-5.png)
...
[![Linked image](../../static/lightbox/test-5.png)](https://example.com/)
